...
// Isso vai fazer com que, quando chamarmos ela em Servicer, ele envia ao banco o usuário normal (completo) mas envia para o Controller um usuário que não tem senha, assim como o JSON não contém a senha do usuário
